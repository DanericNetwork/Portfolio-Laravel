...
<nav>
    <ul class="topnav">
        <li><a class="nav-btn @yield('nav.home')" href="/nl/">Home</a></li>
        <li><a class="nav-btn @yield('nav.about')" href="/nl/about">Over mij</a></li>
        <li><a class="nav-btn @yield('nav.projects')" href="/nl/projects">Projecten</a></li>
        <ul class="socials">
