...
<nav>
    <ul class="topnav">
        <li><a class="nav-btn @yield('nav.home')" href="/en/">Home</a></li>
        <li><a class="nav-btn @yield('nav.about')" href="/en/about">About me</a></li>
        <li><a class="nav-btn @yield('nav.projects')" href="/en/projects">Projects</a></li>
        <ul class="socials">
